...
export const MyList = () => {
  ...
  return (
    <>
      <Head>
        <title>Volunteering - Ulubione</title>
      </Head>
      <main>
        ...
        <div>
          <VolunteeringAnnoucement
            ...
            isPaid={volunteeringPaidToBoolean[selectedVolunteeringData.paid]}
            volunteeringType={volunteeringTypes[selectedVolunteeringData.type]}
            volunteeringTerm={volunteeringTerms[selectedVolunteeringData.term]}
            isFavorite={true}
            isNotifications={
            ...
            showVolunteeringAnnoucementModal={showVolunteeringAnnoucementModal}
            setShowVolunteeringAnnoucementModal={
              setShowVolunteeringAnnoucementModal
            }
              ...
              {volunteeringData.map((volunteering) => {
                return (
                  <div
                    ...
                    key={volunteering.id}
                    onClick={() => {
                      setSelectedVolunteeringData(volunteering)
