		...
		<>
			<div className="relative flex flex-col items-center group">
				...
				<div className="absolute bottom-36 flex flex-col items-center group-hover:opacity-100 opacity-0 transition cursor-default select-none">
					<span className="absolute w-48 z-10 px-2 py-1 text-sm text-white whitespace-no-wrap bg-main-color-2 shadow-lg rounded-md whitespace-pre-wrap">{message}</span>
